...
class TestSeqAuto():
    ...
    multivendors_test_data_set = TestCaseDataset.get_multi_data("Vendors", "case_config.json", "AddVendorMultiple")
    ...
    def test_single_vendor(self):
        test_data = TestCaseDataset.get_single_data("Vendors", "case_config.json", "AddVendorSingle")
